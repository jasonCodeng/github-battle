...
function UserDetails (user) {
    return (
        <div>
            ...
            <li className="list-group-item"> <img src={user.info.avatar_url} className="img-rounded text-center img-responsive"/></li>
            ...
            {user.info.blog && <li className="list-group-item">Website: <a href={user.info.blog}> {user.info.blog}</a></li>}
        </div>
    )
}
